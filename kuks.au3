...
$hGUI = GUICreate("", 140, 66, $Pos[2]+30, 10, $WS_POPUP, $WS_EX_TOPMOST, $hTaskbar_Wnd)
GUISetBkColor(0x000000)
$Input = GUICtrlCreateInput("Search...", 0, 0, 70, 22)
GUICtrlSetColor(-1, 0xC0C0C0)
$radio1 = GUICtrlCreateRadio("AM",80,0,60,22)
GUICtrlSetColor(-1, 0xFFFFFF)
$radio2 = GUICtrlCreateRadio("Forgalmi",80,22,60,22)
GUICtrlSetColor(-1, 0xFFFFFF)
$radio3 = GUICtrlCreateRadio("Global",80,44,60,22)
GUICtrlSetColor(-1, 0xFFFFFF)
$button = GUICtrlCreateButton("Keres",20,30,50,22)
